...
<div class="box">
	...
	<div class="box_right">
    	<a href="sign_up.php">Sign Up</a> - <a href="login.php">Login</a>
    </div>
	<div class="clean"></div>
</div>
<?php
...
<div class="box_login">
	<form action="login.php" method="post">
        ...
        <div class="center">
	        <input type="submit" value="Login" /> <input type="button" onclick="javascript:document.location='sign_up.php';" value="Sign Up" />
        </div>
    </form>
</div>
<?php
